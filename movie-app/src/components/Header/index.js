...
class Header extends React.Component {
    constructor(props){
        ...
        this.state = {
            ...
            titleOfMovie: props.titleOfMovie
        }
    }
    ...
    componentWillReceiveProps(nextProps) {
        this.setState({
            ...
            titleOfMovie: nextProps.titleOfMovie
        })
    }

    render() {
        const { numberOfMovies, titleOfMovie } = this.state
        return (
            <div className="row">
                ...
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div className="collapse navbar-collapse justify-content-md-center" id="navbarsExample08">
                        <ul className="navbar-nav">
                            ...
                            <li className="nav-item">
                                <Link className="nav-link" to={`/popular/movies`}>Popular</Link>
                            </li>
                            <li className="nav-item">
                                <Link className="nav-link" to={`/top-rated/movies`}>Top Movies</Link>
                            </li>
                        </ul>
                    </div>
                </nav>
